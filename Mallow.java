...
public abstract class Mallow extends Plant {
   
   /** Scientific family name. */
   private static String sciFamilyName = "Malvaceae";
   /** Common family name. */
   private static String commonFamilyName = "Mallow";
   /** Genera count. */
   private static int generaCount = 243;
   /** Species count. */
   private static int speciesCount = 4225;
   ...
   */
   public Mallow(String sciPlantName, String commonPlantName,
