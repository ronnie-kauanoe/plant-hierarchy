/**
* Soapberry family class.
* @author Ronnie Kauanoe
* @since 3/1/2019
*/

public abstract class Soapberry extends Plant {
   
   /** Scientific family name. */
   private static String sciFamilyName = "Sapindaceae";
   /** Common family name. */
   private static String commonFamilyName = "Soapberry";
   /** Genera count. */
   private static int generaCount = 135;
   /** Species count. */
   private static int speciesCount = 1600;

   /**
   * Soapberry constructor.
   ...
   */
   public Soapberry(String sciPlantName, String commonPlantName,
