/**
* Morning Glory family class.
* @author Ronnie Kauanoe
* @since 3/1/2019
*/

public abstract class MorningGlory extends Plant {
   
   /** Scientific family name. */
   private static String sciFamilyName = "Convolvulaceae";
   /** Common family name. */
   private static String commonFamilyName = "Morning Glory";
   /** Genera count. */
   private static int generaCount = 57;
   /** Species count. */
   private static int speciesCount = 1600;

   /**
   * Morning Glory constructor.
   ...
   */
   public MorningGlory(String sciPlantName, String commonPlantName,
